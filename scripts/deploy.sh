...
# =============================================================================
# Laravel 12 Starter Kit - Production Deployment Script
# =============================================================================
...
IMAGE_NAME="${APP_NAME:-laravel-app}"
...
check_prerequisites() {
    ...
    if ! grep -q "APP_KEY=base64:" "$ENV_FILE"; then
        ...
        if docker images | grep -q "${IMAGE_NAME}"; then
            NEW_KEY=$(docker run --rm ${IMAGE_NAME}:latest php artisan key:generate --show)
...
wait_for_health() {
    ...
    while [ $ATTEMPT -lt $MAX_ATTEMPTS ]; do
        ...
        APP_HEALTH=$(docker inspect --format='{{.State.Health.Status}}' ${APP_NAME:-laravel-app}-app 2>/dev/null || echo "unknown")
...
main() {
    log_step "======================================================================="
    log_step "Laravel 12 Starter Kit - Production Deployment"
    log_step "======================================================================="
